...
export const setarcargo: Command = {
  data: new SlashCommandBuilder()
    ...
    .addSubcommand((sub) =>
      sub.setName("add").setDescription("Adiciona um cargo a um membro")
    ...
    .addSubcommand((sub) =>
      sub.setName("remover").setDescription("Remove um cargo de um membro")
    ...
    .addSubcommand((sub) =>
      sub.setName("protecao").setDescription("Ativa ou desativa a protecao contra cargos manuais")
        ...
        containerReplyList(`${V} SETAR CARGO — Proteção ${ativar ? "Ativada" : "Desativada"}`, [
          {
            ...
            items: [
              ...
              ativar
                ? "Apenas o bot pode adicionar ou remover cargos. Tentativas manuais serao revertidas."
                : "Membros podem alterar cargos normalmente.",
            ],
          },
        ])
      );
